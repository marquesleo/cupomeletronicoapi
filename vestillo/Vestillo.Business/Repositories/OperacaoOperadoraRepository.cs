...
{
    public class OperacaoOperadoraRepository: GenericRepository<OperacaoOperadora>
    {
        public OperacaoOperadoraRepository()
            : base(new DapperConnection<OperacaoOperadora>())
        {
        }

        public IEnumerable<OperacaoOperadoraView> GetByIdView(int id)
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();

            var SQL = new StringBuilder();
            SQL.AppendLine("SELECT * ");
            SQL.AppendLine("FROM 	operacaooperadora");
            SQL.AppendLine("WHERE id = " + id);
            SQL.AppendLine("ORDER BY Id DESC");

            return cn.ExecuteStringSqlToList(new OperacaoOperadoraView(), SQL.ToString());
        }
        ...
        public OperacaoOperadoraView GetByCupom(int PacoteId, int OperacaoId, string sequencia)
        {
            ...
            var operacao = new OperacaoOperadoraView();
        ...
        public int GetQuantidadeLancadaPorPacote(int PacoteId)
        {
            ...
            var result = cn.ExecuteStringSqlToList(new OperacaoOperadoraView(), SQL.ToString());
            if ( result != null){
                return result.Count();
            }
        ...
        public IEnumerable<OperacaoOperadoraView> GetByFuncionarioIdEData(int funcId, DateTime data)
        {
            ...
            SQL.AppendLine("INNER JOIN funcionarios f ON f.id = oo.FuncionarioId");
        ...
        public IEnumerable<OperacaoOperadoraView> GetByFuncionarioIdEDatas(int funcId, DateTime daData, DateTime ateData)
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();
        ...
        public OperacaoOperadoraView GetByData(DateTime data)
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();
        ...
        public OperacaoOperadoraView GetByYear()
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();
        ...
        public OperacaoOperadoraView GetByDatas(DateTime daData, DateTime ateData)
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();
        ...
        public IEnumerable<OperacaoOperadoraView> GetByFuncionario(int funcId)
        {
            var cn = new DapperConnection<OperacaoOperadoraView>();
